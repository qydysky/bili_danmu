...
func (t *FlvDecoder) Init(buf []byte) (frontBuf []byte, dropOffset int, err error) {
...
func (t *FlvDecoder) SearchStreamFrame(buf []byte, keyframe *slice.Buf[byte]) (dropOffset int, err error) {
